            ...
            <UploadLayout>
                <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
                    <div>
                        ...
                        <h2 className="text-gray-400 mt-1">계정에 비디오 게시</h2>
                    </div>
                    ...
                    <div className="mt-8 md:flex gap-6">
                        ...
                        {!fileDisplay ? 
                            ...
                            >
                                ...
                                <p className="mt-4 text-[17px]">업로드할 동영상 선택</p>
                        ...
                        <div className="mt-4 mb-6">
                            ...
                            <div className="flex gap-3">
                                ...
                                >
                                    {isUploading ? <BiLoaderCircle className="animate-spin" color="#ffffff" size={25} /> : '게시'}
                                </button>
                            </div>
