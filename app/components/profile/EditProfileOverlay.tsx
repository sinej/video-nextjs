                                    ...
                                    <div className="flex items-center justify-center sm:-mt-6">
                                        <div className="sm:w-[60%] w-full max-w-md">
                                            ...
                                            <p className={`relative text-[11px] text-gray-500 ${error ? 'mt-1' : 'mt-4'}`}>
                                                사용자 이름에는 문자, 숫자, 밑줄, 마침표만 포함할 수 있습니다.
                                                사용자 이름을 변경하면 프로필 링크도 변경됩니다.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex items-center justify-center sm:-mt-6">
                                        <div className="sm:w-[60%] w-full max-w-md">
                                            <textarea 
                                                ...
                                                "
                                            ></textarea>
                                            <p className="text-[11px] text-gray-500">{userBio ? userBio.length : 0}/80자</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        {!uploadedImage ? (
                            <div id="UpdateInfoButtons" className="flex items-center justify-end">
                                ...
                                >
                                    <span className="mx-4 font-medium text-[15px]">
                                        {isUpdating ? <BiLoaderCircle color="#ffffff" className="my-1 mx-2.5 animate-spin" /> : "저장" }
                                    </span>
                                </button>
                            ...
                            <div id="CropperButtons" className="flex items-center justify-end" >
                                ...
                                >
                                    <span className="mx-4 font-medium text-[15px]">
                                        {isUpdating ? <BiLoaderCircle color="#ffffff" className="my-1 mx-2.5 animate-spin" /> : "게시" }
                                    </span>
                                </button>
